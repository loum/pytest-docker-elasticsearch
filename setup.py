...
setup(
    name='pytest-docker-elasticsearch',
    version='0.1.0',
    ...
    license='MIT',
    url='https://github.com/loum/pytest-docker-elasticsearch',
    description='A simple plugin to use with pytest',
    long_description=read('README.rst'),
    py_modules=['pytest_docker_elasticsearch'],
    python_requires='>=3.6',
    install_requires=PACKAGES,
    packages=find_packages() + ['pytest_docker_elasticsearch'],
    package_data={'pytest_docker_elasticsearch/docker': ['*.yml']},
    ...
    entry_points={
        'pytest11': [
            'elasticsearch = pytest_docker_elasticsearch',
        ],
    },
)
